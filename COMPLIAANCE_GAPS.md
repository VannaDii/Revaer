...
- [ ] Apply the prescribed UI structure (app/*, core/* logic, services/api+sse, features/* with view/state/logic/api, components presentational only).
- [ ] Restructure CLI/runtime crates to match archetypes (commands/, client.rs, output.rs; runtime bootstrap separated) (runtime crate now follows thin module layout; CLI unchanged and still pending).
