DROP FUNCTION IF EXISTS indexer_backup_export_indexer_instance_list(UUID);
DROP FUNCTION IF EXISTS indexer_backup_export_indexer_instance_list_v1(UUID);
DROP FUNCTION IF EXISTS indexer_backup_export_routing_policy_list(UUID);
DROP FUNCTION IF EXISTS indexer_backup_export_routing_policy_list_v1(UUID);
DROP FUNCTION IF EXISTS indexer_backup_export_rate_limit_policy_list(UUID);
DROP FUNCTION IF EXISTS indexer_backup_export_rate_limit_policy_list_v1(UUID);
DROP FUNCTION IF EXISTS indexer_backup_export_tag_list(UUID);
DROP FUNCTION IF EXISTS indexer_backup_export_tag_list_v1(UUID);
DROP FUNCTION IF EXISTS indexer_backup_assert_actor_v1(UUID);
