-- Torznab instance create and API key rotation procedures.
...
BEGIN
    ...
    api_key_hash_value := crypt(api_key_plaintext, gen_salt('argon2id'));
...
BEGIN
    RETURN QUERY
    SELECT * FROM torznab_instance_create_v1(
...
BEGIN
    ...
    api_key_hash_value := crypt(api_key_plaintext_value, gen_salt('argon2id'));
...
AS $$
BEGIN
    RETURN torznab_instance_rotate_key_v1(actor_user_public_id, torznab_instance_public_id_input);
END;
$$;
