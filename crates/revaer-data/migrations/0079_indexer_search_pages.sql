-- Search request page listing and fetch procedures.

CREATE OR REPLACE FUNCTION search_page_list_v1(
...
BEGIN
    ...
    SELECT search_page_id, sealed_at
...
CREATE OR REPLACE FUNCTION search_page_list(
    actor_user_public_id UUID,
    search_request_public_id_input UUID
)
RETURNS TABLE(
...
CREATE OR REPLACE FUNCTION search_page_fetch(
    actor_user_public_id UUID,
    search_request_public_id_input UUID,
    page_number_input INTEGER
)
