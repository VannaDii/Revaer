-- DHT bootstrap and router node configuration on engine profiles.

ALTER TABLE public.engine_profile
    ADD COLUMN IF NOT EXISTS dht_bootstrap_nodes JSONB NOT NULL DEFAULT '[]'::jsonb,
    ADD COLUMN IF NOT EXISTS dht_router_nodes JSONB NOT NULL DEFAULT '[]'::jsonb;
