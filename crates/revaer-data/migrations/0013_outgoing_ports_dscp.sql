-- Outgoing port range and DSCP/TOS markings for engine profiles.

ALTER TABLE public.engine_profile
    ADD COLUMN IF NOT EXISTS outgoing_port_min INTEGER,
    ADD COLUMN IF NOT EXISTS outgoing_port_max INTEGER,
    ADD COLUMN IF NOT EXISTS peer_dscp INTEGER;
